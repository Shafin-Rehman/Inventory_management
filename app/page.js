...
export default function Home() {
  ...
  return (
    <Box width="100vw" height="100vh" display="flex" justifyContent="center" alignItems="center" flexDirection="column" gap={2} bgcolor="#001524">
      ...
      <Box width="800px" height="60vh" overflow="auto" border="1px solid #333" mt={2}>
        <Box width="100%" height="100px" bgcolor="#a2a77f" display="flex" alignItems="center" justifyContent="center">
        ...
        <Stack>
          {searchResults.map(({ name, quantity }) => (
            <Box
              ...
              bgcolor="#eff6e0"
              padding={5}>
              <Typography variant="h4" color="#001427" textAlign="center">
              ...
              {name !== 'Item not found' && (
                <>
                  ...
                  <Stack direction="row" spacing={2}>
                    <Button variant="contained" onClick={() => addItem(name)} sx={{ bgcolor: "#598392" }}>
                      Add
                    </Button>
                    <Button variant="contained" onClick={() => removeItem(name)} sx={{ bgcolor: "#598392" }}>
                      Remove
                    </Button>
                    <Button variant="contained" onClick={() => handleUpdateClick(name)} sx={{ bgcolor: "#598392" }}>
                      Update
                    </Button>
                  </Stack>
                </>
